...
**Healer positioning under a raid:** a healer anchors on the **tank** (not the leader) while a raid boss is engaged, so the tank — which fights the boss in melee while the leader hangs back — is always in heal range. (Trace from a wipe showed the tank dying un-healed because it was out of the healer's range while the healer topped nearby nukers.)
