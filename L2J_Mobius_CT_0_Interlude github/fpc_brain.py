...
def whisper_persona(fpc, voice):
    return (GLOBAL_RULES + "\n\n" + voice + "\n\n"
            ...
            "(pick the closest match to where they want to meet). Write the tag EXACTLY as [[MEET:gatekeeper]] "
            "with double square brackets to open AND close it; never use shorthand like 'gk' inside the tag and "
            "never close it with ')' or a single bracket. "
